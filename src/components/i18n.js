...
window.I18n = (function () {
  const DICT = {
    en: {
      ...
      'settings.windKmh': 'km/h', 'settings.windKn': 'kn', 'settings.windMs': 'm/s',
      ...
      'dashboard.temp15min': 'Temperature (15 min)', 'dashboard.tempHourly': 'Temperature (Hourly)', 'dashboard.citiesTable': 'Cities Max Temperature',
      'dashboard.citiesTableCity': 'City', 'dashboard.citiesTableMaxTemp': 'Max Temp',
    ...
    fr: {
      ...
      'dashboard.temp15min': 'Température (15 min)', 'dashboard.tempHourly': 'Température (horaire)', 'dashboard.citiesTable': 'Température max. par ville',
    ...
    es: {
      ...
      'dashboard.temp15min': 'Temperatura (15 min)', 'dashboard.tempHourly': 'Temperatura (horaria)', 'dashboard.citiesTable': 'Temp. máx. por ciudad',
    ...
    ar: {
      ...
      'dashboard.temp15min': 'درجة الحرارة (15 دقيقة)', 'dashboard.tempHourly': 'درجة الحرارة (ساعية)', 'dashboard.citiesTable': 'أعلى درجة حرارة حسب المدينة',
