...
window.I18n = (function () {
  const DICT = {
    en: {
      ...
      'settings.windKmh': 'km/h', 'settings.windMph': 'mph',
      ...
      'dashboard.airQuality': 'Air Quality', 'dashboard.temp24': 'Temperature (24h)',
    ...
    fr: {
      ...
      'dashboard.airQuality': 'Qualité de l’air', 'dashboard.temp24': 'Température (24h)',
    ...
    es: {
      ...
      'dashboard.airQuality': 'Calidad del aire', 'dashboard.temp24': 'Temperatura (24h)',
    ...
    ar: {
      ...
      'settings.windKmh': 'كم/س', 'settings.windMph': 'ميل/س',
      ...
      'dashboard.airQuality': 'جودة الهواء', 'dashboard.temp24': 'درجة الحرارة (24 ساعة)',
