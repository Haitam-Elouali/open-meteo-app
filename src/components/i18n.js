...
'nav.home': 'Home', 'nav.dashboard': 'Dashboard', 'nav.forecast': 'Forecast', 'nav.map': 'Weather Map',
      ...
      'location.loadingCities': 'Loading cities...', 'location.errorCities': 'Error loading cities',
      'location.pleaseSelectBoth': 'Please select both country and city', 'location.noMatch': 'No matching location found.', 'location.failedGet': 'Failed to get location data',
    ...
    fr: {
      ...
      'location.loadingCities': 'Chargement des villes...', 'location.errorCities': 'Erreur de chargement des villes',
      'location.pleaseSelectBoth': 'Veuillez sélectionner un pays et une ville', 'location.noMatch': 'Aucun emplacement trouvé.', 'location.failedGet': 'Impossible d’obtenir la localisation',
    ...
    es: {
      ...
      'location.loadingCities': 'Cargando ciudades...', 'location.errorCities': 'Error al cargar ciudades',
      'location.pleaseSelectBoth': 'Selecciona un país y una ciudad', 'location.noMatch': 'No se encontró la ubicación.', 'location.failedGet': 'No se pudo obtener la ubicación',
    ...
    ar: {
      ...
      'location.loadingCities': 'جاري تحميل المدن...', 'location.errorCities': 'خطأ في تحميل المدن',
      'location.pleaseSelectBoth': 'الرجاء اختيار الدولة والمدينة', 'location.noMatch': 'لم يتم العثور على موقع.', 'location.failedGet': 'تعذر الحصول على الموقع',
