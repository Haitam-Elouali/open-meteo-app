...
window.I18n = (function () {
  const DICT = {
    en: {
      ...
      'dashboard.temp15min': 'Temperature (15 min)', 'dashboard.citiesTable': 'Cities Max Temperature',
    ...
    fr: {
      ...
      'dashboard.temp15min': 'Température (15 min)', 'dashboard.citiesTable': 'Température max. par ville',
    ...
    es: {
      ...
      'dashboard.temp15min': 'Temperatura (15 min)', 'dashboard.citiesTable': 'Temp. máx. por ciudad',
    ...
    ar: {
      ...
      'dashboard.temp15min': 'درجة الحرارة (15 دقيقة)', 'dashboard.citiesTable': 'أعلى درجة حرارة حسب المدينة',
