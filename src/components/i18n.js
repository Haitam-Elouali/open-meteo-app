...
window.I18n = (function () {
  const DICT = {
    ...
    fr: {
      ...
      'dashboard.temp': 'Température', 'dashboard.citiesTable': 'Température max. par ville',
    ...
    es: {
      ...
      'dashboard.temp': 'Temperatura', 'dashboard.citiesTable': 'Temp. máx. por ciudad',
    ...
    ar: {
      ...
      'dashboard.temp': 'درجة الحرارة', 'dashboard.citiesTable': 'أعلى درجة حرارة حسب المدينة',
